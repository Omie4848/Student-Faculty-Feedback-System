...
?>
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					<td>Choose Your Domain</td>
					<Td>
					DEVELOPMENT<input value="reading" type="checkbox" name="hob[]"/>
					DESIGNING<input value="singin" type="checkbox" name="hob[]"/>
					
					COMPETITIVE CODING<input value="playing" type="checkbox" name="hob[]"/>
					</td>
				</tr>
